...
$(document).ready(function(){
	...
	function deg_check()
	{
		...
		{
			$('#degvalue').show();
			$('#degvalue').html("Please Enter Valid DA Value..");
			$('#degvalue').focus();
	...
	function basic_check(){
		...
		{
			$('#basicvalue').show();
			$('#basicvalue').html("Please Enter Valid Baic Value..");
			$('#basicvalue').focus();
		...
		function trallow_check()
	{
		...
		{
			$('#trallowvalue').show();
			$('#trallowvalue').html("Please Enter Valid trallow Value..");
			$('#trallowvalue').focus();
		...
		function splallow_check()
	{
		...
		{
			$('#splallowvalue').show();
			$('#splallowvalue').html("Please Enter Valid splallow Value..");
			$('#splallowvalue').focus();
		...
		function tax_check()
	{
		...
		{
			$('#taxvalue').show();
			$('#taxvalue').html("Please Enter Valid Tax Value..");
			$('#taxvalue').focus();
			$('#taxvalue').css("color","red");
			$('#taxvalue').toggle(4000);
...
$('.form-group').on('input','.prc',function(){
		...
		$('.form-group .prc' ).each(function(){
				...
				if($.isNumeric(inputVal)){
					totalEarning += parseFloat(inputVal);
				}
		});

		$('#result').text(totalEarning);
		//$('#result1').text(totalEarning);
		$('#total').val(totalEarning);
		...
		$('#totalvalue').val(totalsum);
		var t1 =  $('#total').val();
		var t2 = $('#totalvalue').val();
		var minus = t1-t2;
		$('#minus').text(minus);
		$('#minusvalue').val(minus);
		});
	});
